...
public class SceneLoaderIntro : MonoBehaviour
{
    ...
    public GameObject playerObject; // Aggiunta della variabile per il GameObject del player
    ...
    {
        if (other.gameObject == playerObject) // Verifica se il GameObject nel trigger è il playerObject
        {
            StartCoroutine(LoadScene("TutorialCavi"));
        }
    }
